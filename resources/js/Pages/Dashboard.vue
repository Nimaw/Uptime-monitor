        ...
        <div class="py-12">
            <div>
                ...
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <form v-on:submit.prevent="storeEndpoint"
                    ...
                    <div class="mt-8">
                        <h2 class="font-semibold text-lg text-gray-800 leading-right"> Currently monitoring({{ endpoints.data.length }})</h2>
...
const endpointForm = useForm({
    location: null,
    frequency: page.props.endpoint_frequencies.data[0].frequency
});
